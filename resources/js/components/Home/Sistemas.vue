        ...
        <section class="py-5">
                ...
                <div class="row">
                    ...
                    <div class="content_suport col-md-6">
                        ...
                        <div class="text-center">
                            <img src="storage/img/services/sistemas.jpg" alt="" class="img-fluid" width="250">
                        </div>
                    </div>
                </div>
            ...
            <div class="mt-0">
                <div class="accordion" id="accordionExample">
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                            <div class="card-body">
                                ...
                                <div class="content_body row mb-2">
                                    ...
                                    <div class="col-12 col-sm-8 col-md-9">
                                        <p class="mb-2">
                                            Soporte técnico en la administración de servidores y bases de datos del LMS. <br>
                        ...
                        <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                            <div class="card-body">
                                ...
                                <div class="content_body row mb-2">
                                    ...
                                    <div class="col-12 col-sm-8 col-md-9">
                                        <p class="mb-2">
                                            Soporte técnico en la administración de servidores y bases de datos del sistema. <br>
                            ...
                            <div class="card-body">
                                ...
                                <div class="content_body row mb-2">
                                    ...
                                    <div class="col-12 col-sm-8 col-md-9">
                                        <p class="mb-2">
                                            Soporte técnico en la administración de servidores y bases de datos del sistema. <br>
                                            Gestión de algunos requerimientos no funcionales del mismo. <br>
                                ...
                                <div class="content_body row mb-2">
                                    ...
                                    <div class="col-12 col-sm-8 col-md-9">
                                        <p class="mb-2">
                                            ...
                                            Capacitar a los usuarios en el diligenciamiento de la información. <br>
                                            Resolución de dudas del proceso <br>
                    ...
                    <div class="card">
                        <div class="card-header collapsed" type="button" data-toggle="collapse" data-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix" id="headingSix">
                            <h2 class="btn btn-link mb-0">
                                •	Sitio Web
                            </h2>
                        </div>
                        <div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-parent="#accordionExample">
                            <div class="card-body">
                                ...
                                <div class="content_body row mb-2">
                                    ...
                                    <div class="col-12 col-sm-8 col-md-9">
                                        <p class="mb-2">
                                            Soporte técnico en la administración de servidores y bases de datos del sitio web y los micro sitios del sistema. <br>
                                            Gestión de algunos requerimientos no funcionales del mismo.
                    ...
                    <div class="card">
                        <div class="card-header collapsed" type="button" data-toggle="collapse" data-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven" id="headingSeven">
                            <h2 class="btn btn-link mb-0">
                                •	SIAAC
                            </h2>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-header collapsed" type="button" data-toggle="collapse" data-target="#collapseEight" aria-expanded="false" aria-controls="collapseEight" id="headingEight">
                            <h2 class="btn btn-link mb-0">
                                •	GLPI
                            </h2>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-header collapsed" type="button" data-toggle="collapse" data-target="#collapseNine" aria-expanded="false" aria-controls="collapseNine" id="headingNine">
                            <h2 class="btn btn-link mb-0">
                                •	OCSSINVENTORY
                            </h2>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-header collapsed" type="button" data-toggle="collapse" data-target="#collapseTen" aria-expanded="false" aria-controls="collapseTen" id="headingTen">
                            <h2 class="btn btn-link mb-0">
                                •	AlienVault
                            </h2>
                        </div>
